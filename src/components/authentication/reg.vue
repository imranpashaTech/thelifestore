<template>
    <section class="Reg">
        <form class="signup-screen mt-5" >
            
            <h3 class="text-center">Register Here</h3>
            <div class="form-group border-bottom">
                    <label>Name : </label>
                    <input class="col-md-12" v-model="loginDetails.username" placeholder="enter your name">
            </div>
            <div class="form-group border-bottom">
                    <label>Email : </label>
                    <input type="email" class="col-md-12" v-model="loginDetails.username" placeholder="enter your email">
            </div>
            <div class="form-group border-bottom">
                    <label>Phone : </label>
                    <input type="phone" maxlength="10" class="col-md-12" v-model="loginDetails.username" placeholder="enter your phone">
            </div>
            <div class="form-group  border-bottom">
            ...
            <div class="form-group text-center pt-4">
                <button type="button" class="btn btn-primary" @click="Login()">Register</button> 
            </div>
        </form>
